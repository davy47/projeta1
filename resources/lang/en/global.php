...
return [
    ...
    'areYouSure'                           => 'êtes vous sur de vouloir?',
    'clickHereToVerify'                    => 'Click here to verify',
    'create'                               => 'Créer',
    'dashboard'                            => 'Tableau de bord',
    'delete'                               => 'Suprimer',
    'downloadFile'                         => 'Telecharger le ficher',
    'edit'                                 => 'Modifier',
    'emailVerificationSuccess'             => 'email verifié avec succès',
    'entries'                              => 'Entrer',
    'filterDate'                           => 'Filter par date',
    ...
    'login_password_confirmation'          => 'Confirmer le mot de passe',
    'logout'                               => 'Se deconnecter',
    'month'                                => 'Mois',
    'no'                                   => 'Non',
    'pleaseSelect'                         => 'veiller selectionner',
    "register"                             => "S'enregister",
    'remember_me'                          => 'Rester connecté',
    'reset_password'                       => 'modifier le mot de passe',
    'send_password'                        => 'envoyer un lien de modification du mot de passe',
    'save'                                 => 'enregistre',
    'search'                               => 'Rechercher',
    'searching'                            => 'rechercher en cours',
    'no_results'                           => 'auccun resultat trouvé',
    'results_could_not_be_loaded'          => 'les resultats ne peuvent pas être affichés',
    'search_input_too_short'               => 'les caractères entrés sont trop courts',
    'show'                                 => 'Afficher',
    'systemCalendar'                       => 'Calendier',
    'thankYouForUsingOurApplication'       => 'Outils de Gestion Arts Terra',
    'timeFrom'                             => 'pour',
    'timeTo'                               => 'par',
    ...
    'view'                                 => 'Afficher',
    'view_file'                            => 'Afficher ficher',
    'year'                                 => 'an',
    'yes'                                  => 'oui',
    'youAreLoggedIn'                       => 'Vous êtes connectés !',
    'yourAccountNeedsAdminApproval'        => 'Your accounts needs an administrator approval in order to log in',
    'submit'                               => 'Valider',
    'relatedData'                          => 'Related Data',
    'change_password_success'              => 'Mot de passe connecter avec succès',
    'datatables'                           => [
        'copy'          => 'Copy',
        'csv'           => 'CSV',
        'excel'         => 'Excel',
        'pdf'           => 'PDF',
        'print'         => 'Print',
        'colvis'        => 'afficher les elements',
        'delete'        => 'suprimer la selection',
    ...
    'asset'                                => 'Produit',
    'assets'                               => 'Produits',
    'assets_history'                       => 'rapport de produits',
    'assets_management'                    => 'Gestion des produits',
    'assigned_to'                          => 'Assigned to',
    'assigned_user'                        => 'Assigned (user)',
    'attachment'                           => 'Attachment',
    'axis'                                 => 'Axis',
    'back_to_list'                         => 'Retourner à la page précedente',
    'basic_crm'                            => 'Basic CRM',
    'budget'                               => 'Budget',
    ...
    'companies'                            => 'Companies',
    'company'                              => 'entreprise',
    "company_name"                         => "non de l'entreprise",
